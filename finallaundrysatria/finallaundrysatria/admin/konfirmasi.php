        ...
        $_SESSION['msg'] = ''; ?>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="bayar.php?id=<?= $trans['id_transaksi']; ?>" type="button" data-toggle="tooltip" title="" class="button" data-original-title="Detail">
                        ...
                        <br><a href="transaksi.php" class="link">Kembali</a>
